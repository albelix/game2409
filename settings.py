...
USE_POINTS = True
POINTS_CUSTOM_NAME = 'токенов' # Added by GC
...
# in SESSION_CONFIGS, except those that explicitly override it.hero
...
ROOMS = [
    ...
    },
    {
        'name': 'lab7',
        'display_name': 'p7',
        'participant_label_file': 'PlayerList7.txt',
        'use_secure_urls': False,
    },
    {
        'name': 'lab8',
    ...
    },
    {
        'name': 'lab60',
        'display_name': 'p60',
        'participant_label_file': 'PlayerList60.txt',
        'use_secure_urls': False,
    },
    # {
    #     'name': 'city_5',
...
SESSION_CONFIG_DEFAULTS = {
    ...
    'participation_fee': 150.00, # !! THIS WAS 150
    'doc': "",
...
SESSION_CONFIGS = [
    ...
    # {
    #     'name': 'PrefRev',
    #     'display_name': "Preference Reversals Test",
    #     'num_demo_participants': 1,
    #     'app_sequence': ['survey_prefrev'],
    # },
        # {
    # 'name': 'Contracts_H_VS_R',
    # 'display_name': "Contracts_H_VS_R",
    # 'num_demo_participants': 4,
    # 'app_sequence': ['mpl','contracts_H_vs_R','c_survey'],
    # },
    {
    ...
    #     'name': 'survey_prefrev',
    #     'num_demo_participants': 1,
    #     'app_sequence': ['survey_prefrev', 'payment_info'],
    # },
    {
        'name': 'Contracts_H_VS_R',
        'display_name': "Contracts_H_VS_R",
    ...
    {
        'name': 'PG_standard_NS',
        'display_name': "Базовая игра Public Goods",
    ...
    #     'num_demo_participants': 1,
    #     'app_sequence': ['real_effort', 'my_survey_eng'],
    # },
    {
        'name': 'risk_real_effort',
        'display_name': 'Risk Real Effort Task',
        'num_demo_participants': 1,
        'app_sequence': ['realefforttask', 'colors', 'my_survey'],
    },
    {
        'name': 'colors',
        'display_name': "Colors",
        'num_demo_participants': 1,
        'app_sequence': ['colors', 'my_survey'],
    },
